...
string url = "http://localhost:5077/api/Purchase/tickets"; // Đổi port của bạn

Console.WriteLine("Bắt đầu bắn 5 request đồng thời...");
...
Console.WriteLine("Hoàn tất test Concurrency.");
