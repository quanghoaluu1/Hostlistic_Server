...
public class EventEngagementAnalyticsDto
{
    ...
    public List<EventEngagementSessionAnalyticsDto> Sessions { get; set; } = [];
}

public class EventEngagementSessionAnalyticsDto
{
    public Guid SessionId { get; set; }
