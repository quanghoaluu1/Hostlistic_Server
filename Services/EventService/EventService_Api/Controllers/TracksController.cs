...
public class TracksController : ControllerBase
{
    ...
    // {
    //     var result = await _trackService.GetTrackByIdAsync(TODO, trackId);
    ...
    // {
    //     var result = await _trackService.CreateTrackAsync(TODO, request);
    //     if (!result.IsSuccess) return BadRequest(result);
    //     return Ok(result);
    // }
    //
    ...
    // {
    //     var result = await _trackService.DeleteTrackAsync(TODO, trackId);
    //     if (!result.IsSuccess) return BadRequest(result);
    //     return Ok(result);
    // }
}