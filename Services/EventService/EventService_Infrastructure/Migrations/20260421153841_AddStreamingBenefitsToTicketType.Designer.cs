...
namespace EventService_Infrastructure.Migrations
{
    ...
    [Migration("20260421153841_AddStreamingBenefitsToTicketType")]
    partial class AddStreamingBenefitsToTicketType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventService_Domain.Entities.SurveyForm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EventService_Domain.Entities.SurveyResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EventService_Domain.Entities.TicketType", b =>
                {
                    ...
                    b.PrimitiveCollection<List<Guid>>("AllowedTrackIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid[]")
            ...
            modelBuilder.Entity("EventService_Domain.Entities.SurveyResponse", b =>
                {
                    b.HasOne("EventService_Domain.Entities.SurveyForm", "SurveyForm")
                        .WithMany("Responses")
